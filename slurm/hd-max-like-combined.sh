...
#SBATCH --job-name hd-max-like-combined
#SBATCH --mail-user=wrightd2@oregonstate.edu
#SBATCH --mail-type=ALL
#SBATCH --output ./logs/hd-max-like-combined-%A-%a-stdout.log
#SBATCH --error ./logs/hd-max-like-combined-%A-%a-stderr.log
...
$PIXI run python ../analysis.py run-array-max-like \
    --data-dir "$DATADIR/fake_feathers_spna" \
    --svi-samples 50000 \
    --batch-size 1000 \
    --rn-comp 30 \
    --gw-comp 7
