...
#SBATCH --job-name split-pta
#SBATCH --mail-user=wrightd2@oregonstate.edu
#SBATCH --mail-type=ALL
#SBATCH --output ./logs/split-pta-%A-%a-stdout.log
#SBATCH --error ./logs/split-pta-%A-%a-stderr.log
...
$PIXI run mpirun --mca pml ob1 -n $SLURM_NTASKS  python ../simulation.py split-simulated-pta-parallel \
    --data-dir "$DATADIR" \
