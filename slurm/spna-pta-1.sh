...
##SBATCH --account ph
##SBATCH --time 00:30:00
#SBATCH --job-name spna-pta-1
#SBATCH --mail-user=wrightd2@oregonstate.edu
#SBATCH --mail-type=ALL
#SBATCH --output ./logs/spna-pta-1-%A-%a-stdout.log
#SBATCH --error ./logs/spna-pta-1-%A-%a-stderr.log
...
$PIXI run mpirun --mca pml ob1 -n $SLURM_NTASKS  python ../simulation.py spna-max-likelihood-parallel \
    --feather-dir "$DATADIR/fake_feathers_pta_1" \
    --svi-samples 100000 \
    --svi-batch-size 1000 \
    --use-mpi
